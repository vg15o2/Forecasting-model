...
results.to_excel(f'BPNNNO2forecast_results_fold_{fold}.xlsx', index=False)
...
plt.xlabel('Time')
plt.ylabel('Value')
plt.title('Comparison of Forecast and Actual Values of NO2')
plt.legend()
plt.show()
fig.savefig('BPNNNO2.png')
