...
train_data = data[(dates >= '2013') & (dates <= '31-12-2019')]
test_data = data[(dates >= '1-1-2023') & (dates <= '31-12-2024')]
...
forecast_data.to_excel('Eth-Benzene.xlsx'.format(fold), index=False)
...
plt.plot(test_data['From Date'][n_steps-1:], y_pred.flatten(), label='Forecast',color='#00FF00')
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Eth-Benzene 2023-2024 Forecast')
plt.legend()
plt.show()
fig.savefig('WNNEth-Benzene.png')
