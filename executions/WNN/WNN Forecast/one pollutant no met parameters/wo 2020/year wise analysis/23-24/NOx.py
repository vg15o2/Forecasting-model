...
forecast_data.to_excel('NOx.xlsx'.format(fold), index=False)
...
plt.plot(test_data['From Date'][n_steps-1:], y_pred.flatten(), label='Forecast',color='#964B00')
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('NOx 2023-2024 Forecast')
plt.legend()
plt.show()
fig.savefig('WNNNOx.png')
