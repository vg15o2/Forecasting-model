...
forecast_data.to_excel('Ozone.xlsx'.format(fold), index=False)
...
plt.plot(test_data['From Date'][n_steps-1:], y_pred.flatten(), label='Forecast',color='#FFD700')
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Ozone 2023-2024 Forecast')
plt.legend()
plt.show()
fig.savefig('WNNOzone.png')
