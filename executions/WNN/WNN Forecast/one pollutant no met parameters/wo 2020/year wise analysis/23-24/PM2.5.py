...
train_data = data[(dates >= '23-03-2015') & (dates <= '31-12-2019')]
...
forecast_data.to_excel('PM2.5.xlsx'.format(fold), index=False)
...
plt.plot(test_data['From Date'][n_steps-1:], y_pred.flatten(), label='Forecast',color='#FF00FF')
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('PM2.5 2023-2024 Forecast')
plt.legend()
plt.show()
fig.savefig('WNNPM2.5.png')
