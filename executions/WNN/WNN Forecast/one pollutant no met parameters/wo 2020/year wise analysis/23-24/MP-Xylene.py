...
forecast_data.to_excel('MP-Xylene.xlsx'.format(fold), index=False)
...
plt.plot(test_data['From Date'][n_steps-1:], y_pred.flatten(), label='Forecast',color='#008080')
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('MP-Xylene 2023-2024 Forecast')
plt.legend()
plt.show()
fig.savefig('WNNMP-Xylene.png')
