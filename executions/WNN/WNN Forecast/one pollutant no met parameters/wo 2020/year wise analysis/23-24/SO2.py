...
forecast_data.to_excel('SO2.xlsx'.format(fold), index=False)
...
plt.plot(test_data['From Date'][n_steps-1:], y_pred.flatten(), label='Forecast',color='#800080')
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('SO2 2023-2024 Forecast')
plt.legend()
plt.show()
fig.savefig('WNNSO2.png')
