...
forecast_data.to_excel('NO.xlsx'.format(fold), index=False)
...
plt.plot(test_data['From Date'][n_steps-1:], y_pred.flatten(), label='Forecast',color='#FFA500')
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('NO 2023-2024 Forecast')
plt.legend()
plt.show()
fig.savefig('WNNNO.png')
