...
forecast_data.to_excel('Benzene.xlsx'.format(fold), index=False)
...
plt.plot(test_data['From Date'][n_steps-1:], y_pred.flatten(), label='Forecast',color='#0000FF')
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Benzene 2023-2024 Forecast')
plt.legend()
plt.show()
