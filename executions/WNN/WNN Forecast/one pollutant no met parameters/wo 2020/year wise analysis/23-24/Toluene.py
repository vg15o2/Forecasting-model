...
forecast_data.to_excel('Toluene.xlsx'.format(fold), index=False)
...
plt.plot(test_data['From Date'][n_steps-1:], y_pred.flatten(), label='Forecast',color='#00FFFF')
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Toluene 2023-2024 Forecast')
plt.legend()
plt.show()
