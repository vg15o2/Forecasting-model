...
target_variable = 'Toluene (ug/m3)'  # Update with the desired target pollutant
...
forecast_data.to_excel('WNNTolueneforecast_results.xlsx', index=False)
