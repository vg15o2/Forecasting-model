...
target_variable = 'Benzene (ug/m3)'  # Update with the desired target pollutant

# Filter the data for the desired date range
train_data = data[(dates >= '23-03-2015') & (dates <= '2020')]
test_data = data[(dates >= '2021') & (dates <= '11-2-2024')]

# Define the input pollutants
input_pollutants = ['PM2.5 (ug/m3)','NO (ug/m3)', 'NO2 (ug/m3)', 'NOx (ppb)', 'SO2 (ug/m3)',
                    'Ozone (ug/m3)', 'Benzene (ug/m3)', 'Toluene (ug/m3)', 'Eth-Benzene (ug/m3)',
                    'MP-Xylene (ug/m3)','Temp (degree C)','RH (%)','WS (m/s)','WD (deg)','SR (W/mt2)']
...
forecast_data.to_excel('WNNBenzeneforecast_results.xlsx', index=False)
