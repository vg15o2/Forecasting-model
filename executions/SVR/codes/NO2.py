...
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Forecast vs Actual of NO2'.format(fold))
plt.legend()
plt.show()
fig.savefig('SVRNO2_fold{}.png'.format(fold))
...
forecast_data.to_excel('SVRNO2forecast_results_fold{}.xlsx'.format(fold), index=False)
