...
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Forecast vs Actual of NOx'.format(fold))
plt.legend()
plt.show()
fig.savefig('SVRNOx_fold{}.png'.format(fold))
...
forecast_data.to_excel('SVRNOxforecast_results_fold{}.xlsx'.format(fold), index=False)
