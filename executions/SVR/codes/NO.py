...
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Forecast vs Actual of NO'.format(fold))
plt.legend()
plt.show()
fig.savefig('SVRNO_fold{}.png'.format(fold))
...
forecast_data.to_excel('SVRNOforecast_results_fold{}.xlsx'.format(fold), index=False)
