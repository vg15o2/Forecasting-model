...
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Forecast vs Actual of MP-Xylene'.format(fold))
plt.legend()
plt.show()
fig.savefig('SVRMP-Xylene_fold{}.png'.format(fold))
...
forecast_data.to_excel('SVRMP-Xyleneforecast_results_fold{}.xlsx'.format(fold), index=False)
