...
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Forecast vs Actual of Ozone'.format(fold))
plt.legend()
plt.show()
fig.savefig('SVROzone_fold{}.png'.format(fold))
...
forecast_data.to_excel('SVROzoneforecast_results_fold{}.xlsx'.format(fold), index=False)
