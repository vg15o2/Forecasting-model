...
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Forecast vs Actual of SO2'.format(fold))
plt.legend()
plt.show()
fig.savefig('SVRSO2_fold{}.png'.format(fold))
...
forecast_data.to_excel('SVRSO2forecast_results_fold{}.xlsx'.format(fold), index=False)
