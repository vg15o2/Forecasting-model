...
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Forecast vs Actual of PM2.5'.format(fold))
plt.legend()
plt.show()
fig.savefig('SVRPM2.5_fold{}.png'.format(fold))
...
forecast_data.to_excel('SVRPM2.5forecast_results_fold{}.xlsx'.format(fold), index=False)
