...
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Forecast vs Actual of Toluene'.format(fold))
plt.legend()
plt.show()
fig.savefig('SVRToluene_fold{}.png'.format(fold))
...
forecast_data.to_excel('SVRTolueneforecast_results_fold{}.xlsx'.format(fold), index=False)
