...
plt.xlabel('Date')
plt.ylabel('Value')
plt.title('Forecast vs Actual of Eth-Benzene'.format(fold))
plt.legend()
plt.show()
fig.savefig('SVREth-Benzene_fold{}.png'.format(fold))
...
forecast_data.to_excel('SVREth-Benzeneforecast_results_fold{}.xlsx'.format(fold), index=False)
